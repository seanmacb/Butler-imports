...
# === CONFIGURATION ===
PATH_LIST="outPathsLocal.csv"  # Each line is a full path on remote2, e.g., /taiga/.../file.fits
...
cat "$PATH_LIST" | xargs -n1 -P"$NUM_PARALLEL" -I{} bash -c '
    ...
    rsync -avz --password-file=pwFile --inplace $user@desar.cosmology.illinois.edu::deca_archive/$rel_path/p*/coadd/ $out_path || echo " ⚠️ Failed: $rel_path"
